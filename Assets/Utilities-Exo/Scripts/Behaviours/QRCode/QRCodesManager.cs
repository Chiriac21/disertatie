...
namespace QRTracking
{
    ...
    public class QRCodesManager : Singleton<QRCodesManager>
    {
        ...
        private GameObject mainMenu, rosy, QRCode;
        ...
        async protected virtual void Start()
        {
            ...
            rosy = GameObject.Find("RosyDis(Clone)");
        ...
        private void Update()
        {
            if (IsExitPressed)
            {
                ...
                FindObjectOfType<QRCode>().objInstantiated = false;
                Debug.Log(FindObjectOfType<QRCode>().objInstantiated);
                Destroy(rosy);
                Destroy(QRCode);
                IsExitPressed = false;
            }
